...
void insertarCDP(sqlite3 *db) {
    const char *sql_insert_data = R"(
        ...
        (7000001, '702890948', 2701006, '2023-11-30', 'Dolares', '2028-05-30', 15000.0, 1500.0, 3.01, 47, 54),
        (7000002, '702890950', 2701027, '2023-08-02', 'Dolares', '2024-09-02', 10000.0, 1800.0, 0.18, 3, 13),
        (7000003, '702890951', 2701019, '2023-11-08', 'Dolares', '2025-07-08', 13000.0, 7800.0, 0.6, 13, 20),
        (7000004, '702890952', 1701014, '2022-10-20', 'Colones', '2025-03-20', 350000.0, 423500.0, 1.21, 11, 29),
        (7000005, '504380806', 1504004, '2021-01-26', 'Colones', '2024-12-26', 300000.0, 933000.0, 3.11, 6, 47),
        (7000009, '901460040', 1203004, '2024-06-30', 'Colones', '2025-12-26', 300000.0, 933000.0, 0.6, 18, 18),
        (7000006, '901460040', 1203004, '2020-02-01', 'Colones', '2024-05-01', 320000.0, 1136000.0, 3.11, 0, 47);
    )";
