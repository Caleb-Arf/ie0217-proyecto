...
int insertarDatosClientes(sqlite3 *db) {
    const char* insertDataSQL = R"(
        ...
        (2701006, '702890948', 'YAKIR HERMAN BUSTOS', '6543 1234', 'San Jose, Barrio Escalante', 'yakir.herman@hotmail.com', 87654.22, Dolares),
        (2701027, '702890950', 'MARLENNY MAROTO GUADAMUZ', '8745 6789', 'Heredia, San Francisco', 'marleny.maroto@yahoo.com', 20985.98, Dolares),
        (2701019, '702890951', 'ANNIA CORTES SOLANO', '9032 1567', 'Alajuela, San Rafael', 'annia.cortes@gmail.com', 98745.22, Dolares),
        (1701014, '702890952', 'LILLIAM VILLAVICENCIO HIDALGO', '7834 9087', 'Cartago, Paraiso', 'lilliam.villavicencio@hotmail.com', 1450987.45, Colones),
        (1504004, '504380806', 'ANA HERNANDEZ TORRES', '6012 3456', 'San Jose, La Sabana', 'ana.hernandez@yahoo.com', 654987.33, Colones),
        (1203004, '901460040', 'NESTOR AURELIO CHACON MONCADA', '6546 8901', 'Cartago, Tejar', 'nestor.chacon@hotmail.com', 4421987.12, Colones);
    )";
        sqlite3_stmt *stmt;
    const char *pzTest;
    char *errMsg = nullptr;
